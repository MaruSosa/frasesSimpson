...
function App() {
  ...
  const consultarAPI = async () => {
    //async asincrona para que funcione el await
    try {
      //es basicamente una estructura para controlar la ejecucion de mi codigo
      const respuesta = await fetch(
        "https://thesimpsonsquoteapi.glitch.me/quotes"
      ); //solicitud a la api await espera que haga la solicitud
      ...
      //si el codigo fallo en alguna linea lleva a esta parte la variable error guarda que el error que se produjo
      console.log(error);
